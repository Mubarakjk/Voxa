...
const styles = StyleSheet.create({
  ...
  screenHeaderCopy: { flex: 1, minWidth: 0, gap: spacing.sm },
  ...
  sectionCardCopy: { flex: 1, minWidth: 0, gap: spacing.sm },
  ...
  statLabel: { lineHeight: 17 },
  statValue: { fontSize: 20, lineHeight: 26 },
  statDetail: { lineHeight: 18 },
  ...
  emptyTitle: { textAlign: 'center', maxWidth: 300, lineHeight: 24 },
